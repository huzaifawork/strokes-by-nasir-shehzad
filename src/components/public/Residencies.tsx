          ...
          >
            ...
            >
              ...
              <div className="bg-black/90 md:bg-gradient-to-t md:from-black/80 md:to-transparent p-4 sm:p-6 text-white md:absolute md:bottom-0 md:left-0 md:right-0">
                <h3 className="text-xl sm:text-2xl font-medium mb-2">{residencies[selectedImage].title}</h3>
                <p className="text-sm text-gray-300 leading-relaxed">{residencies[selectedImage].description}</p>
              </div>
            </motion.div>
