          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 text-white">
                <h3 className="text-2xl font-medium mb-2">{galleryItems[selectedImage].name}</h3>
                <p className="text-sm text-gray-300 mb-2">{galleryItems[selectedImage].description}</p>
