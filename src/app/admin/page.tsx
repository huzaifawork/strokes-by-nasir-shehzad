...
import { LuImage, LuCalendar, LuMapPin, LuArrowRight, LuAward } from 'react-icons/lu';
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-10">
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-gray-500">Manage history</p>
              </Link>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-gray-500">Manage journeys</p>
              </Link>
            </motion.div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 bg-amber-50 rounded-xl group-hover:bg-amber-100 transition-colors">
                    <LuAward className="w-6 h-6 text-amber-600" />
                  </div>
                  <LuArrowRight className="w-5 h-5 text-gray-400 group-hover:text-black group-hover:translate-x-1 transition-all" />
                </div>
                <h3 className="text-lg font-semibold text-black mb-1">Awards</h3>
                <p className="text-sm text-gray-500">Manage honors</p>
              </Link>
            </motion.div>
          </div>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              ...
              You can add, edit, and delete items from the Gallery, Exhibitions, Residencies, and Certificates & Awards sections.
            </p>
          </motion.div>
        </div>
      </AdminLayout>
